...
if [ "$OS_TYPE" = "Darwin" ]; then
  ...
  BREW_PKGS="git gh neovim fzf zoxide eza bat ripgrep fd git-delta tlrc node usbutils coreutils yazi hexyl fastfetch sevenzip resvg exiftool glow vhs charmbracelet/tap/freeze charmbracelet/tap/wishlist"
