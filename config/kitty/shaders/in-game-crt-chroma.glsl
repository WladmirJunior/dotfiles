...
// [0, 1]
#define NOISE_UNIFORM_STRENGTH 0.05
...
// [0, 1]
#define BLOOM_STRENGTH 0.060

// Backgrond opacity
// [0, 1]
#define BACKGROUND_OPACITY 0.8

// cool-retro-term emulation (brightness 0.5, contrast 0.8, ambientLight 0.20)
// Compress highlights
// [0, 1]
#define CRT_CONTRAST 0.80
// Wash out colors toward gray
// [0, 1]
#define CRT_SATURATION 0.55
// Lift black level like ambient light on the tube
// [0, 1]^3
#define CRT_AMBIENT 0.050, 0.070, 0.054
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    // Emulate cool-retro-term brightness/contrast/saturation/ambient light
    float crtLuma = dot(fragColor.rgb, vec3(0.299, 0.587, 0.114));
    fragColor.rgb = mix(vec3(crtLuma), fragColor.rgb, CRT_SATURATION);
    fragColor.rgb *= CRT_CONTRAST;
    fragColor.rgb += vec3(CRT_AMBIENT) * (1.0 - fragColor.rgb);
