...
ln -s "$ROOT/lib/trash.sh" "$TMP/dotfiles/lib/trash.sh"
ln -s "$ROOT/lib/ui.sh" "$TMP/dotfiles/lib/ui.sh"
ln -s "$ROOT/lib/state.sh" "$TMP/dotfiles/lib/state.sh"
ln -s "$ROOT/lib/theme.sh" "$TMP/dotfiles/lib/theme.sh"
